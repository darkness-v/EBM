"""
Code From https://github.com/TakHemlata/RawBoost-antispoofing/blob/main/RawBoost.py
"""
...
def LnL_convolutive_noise(x,N_f=5,nBands=5,minF=20,maxF=8000,minBW=100,maxBW=1000,minCoeff=10,maxCoeff=100,minG=0,maxG=0,minBiasLinNonLin=5,maxBiasLinNonLin=20,fs=16000):
    y = [0] * x.shape[0]
...
def SSI_additive_noise(x,fs=16000,SNRmin=10,SNRmax=40,nBands=5,minF=20,maxF=8000,minBW=100,maxBW=1000,minCoeff=10,maxCoeff=100,minG=0,maxG=0):
